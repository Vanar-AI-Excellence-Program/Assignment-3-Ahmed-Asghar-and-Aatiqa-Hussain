...
<div class="border-t border-gray-700/50 bg-gradient-to-r from-gray-900/90 via-black/80 to-gray-900/90 backdrop-blur-sm p-4 relative overflow-hidden">
	...
	{#if selectedFile}
		...
		<div class="relative z-10 max-w-4xl mx-auto mt-2 mb-2">
			<span class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-300 text-sm">
				<svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
				<span class="truncate max-w-[22rem]">{selectedFile.name}</span>
				<button on:click={removeFile} aria-label="Remove file" class="ml-1 rounded-full hover:bg-blue-500/15 p-1">
